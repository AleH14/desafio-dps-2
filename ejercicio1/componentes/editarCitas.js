...
const EditarCita = ({ route, navigation, citas, setCitas, guardarCitasStorage, orientation, screenData }) => {
  ...
  const confirmarHora = (time) => {
    ...
    setFechaCompleta((prev) => {
      const nuevaFecha = prev ? new Date(prev) : new Date();
        ...
        >
          <View style={[styles.contenedorCampos, dynamicStyles.contenedorCampos]}>
            ...
            <TouchableOpacity style={styles.botonDate} onPress={showDatePicker}>
              <Text style={styles.textoBotonDate}>Seleccionar Fecha</Text>
            </TouchableOpacity>
            <DateTimePickerModal
            ...
            <TouchableOpacity style={styles.botonDate} onPress={showTimePicker}>
              <Text style={styles.textoBotonDate}>Seleccionar Hora</Text>
            </TouchableOpacity>
            <DateTimePickerModal
